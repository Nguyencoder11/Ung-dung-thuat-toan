...
tử đã lấy trong a (nếu có). 
- Cài đặt thuật toán Boyer Moore Horspool cho biết chuỗi ký tự Q 
có phải là một chuỗi con của chuỗi ký tự P hay không?
- Khởi tạo số nguyên dương n, mảng số thực a với các số theo chiều tăng dần, khởi 
tạo số C. 
- Khởi tạo 2 chuỗi ký tự P và Q. 
- Sử dụng các thuật toán đã cài đặt ở trên để hiển thị ra màn hình 
các giá trị D, M, các giá trị đã lấy trong mảng a (nếu có phương 
